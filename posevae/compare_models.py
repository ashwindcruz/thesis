...
online_data_1 = []
exp_folder= '.'
with open(exp_folder+'/vae_long_3_results/test_log.txt', 'r') as f:
	f.readline()
	for line in f: 
		data = line.split(',')
...
with open(exp_folder+'/iwae_long_3_results/test_log.txt', 'r') as f:
	f.readline()
	for line in f: 
		data = line.split(',')
...
with open(exp_folder+'/householder_long_3_results/test_log.txt', 'r') as f:
	f.readline()
	for line in f: 
		data = line.split(',')
...
plt.savefig(exp_folder+ '/compare_test_results.png')
