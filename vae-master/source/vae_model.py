...
class VAE_gaussian(FunctionSet):
	...
	# This function calculates the KL from a standard normal which is the form of p(z)
	# Links to the second term of equation 9 in Doersch. But -ve
        kl = F.gaussian_kl_divergence(enc_mu,enc_log_sigma_2)

	# Sample a single z
	# _nll gives you the negative log likelihood given those Gaussian parameters
	# Links to the first term of equation 9 in Doersch. But -ve. log(P(X|z))
